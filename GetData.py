...
def FigureExtract(domain_name_list):
    ...
    figure = list(zip(figure_root_domain_name, figure_length, figure_info_entropy, figure_vowel_ratio, figure_number_ratio))
    return figure


if __name__ == "__main__":
    domain_name_list, label_list = GetRawInfo("train.txt", True)
    x_train, y_train = FigureExtract(domain_name_list), label_list
